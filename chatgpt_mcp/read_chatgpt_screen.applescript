							...
							if i < count of buttonsList then
								...
								try
									...
									if nextBtnHelp is not missing value then
										if (nextBtnHelp contains "음성" or nextBtnHelp contains "받아쓰기" or nextBtnHelp contains "voice" or nextBtnHelp contains "dictation" or nextBtnHelp contains "speech") then
